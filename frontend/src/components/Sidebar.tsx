    ...
    <>
      ...
      <div className="border-t border-gray-200 p-4 space-y-3">
        ...
        <div className="space-y-1">
          ...
          {/* Webhooks - Show to all users, lock icon for FREE/BASIC */}
          <Link
            ...
            title={isCollapsed ? (user?.plan === 'GROWTH' ? 'Webhooks' : 'Webhooks (GROWTH only)') : undefined}
          >
            <Webhook size={18} className={pathname === '/settings/webhooks' ? 'text-purple-600' : user?.plan === 'GROWTH' ? 'text-charcoal-400' : 'text-gray-400'} />
            {!isCollapsed && (
              <div className="flex items-center gap-2 flex-1">
