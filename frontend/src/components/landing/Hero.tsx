    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
      <div className="text-center max-w-4xl mx-auto">
        <h1 className="text-5xl lg:text-6xl font-bold text-charcoal-900 mb-6 leading-tight tracking-tight">
          ...
          <span className="text-coral-600"> Meta Ads </span>
          with AI
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="group inline-flex items-center gap-2 bg-coral-500 hover:bg-coral-600 text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-sm hover:shadow-lg transition-all duration-200 hover:-translate-y-1"
          >
            Start Creating Free
