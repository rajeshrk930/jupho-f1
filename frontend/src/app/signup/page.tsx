  ...
  return (
    <div className="min-h-screen bg-base-surface flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-base-elevated rounded-md border border-border-default p-6 md:p-8 shadow-sm">
          ...
          <p className="text-center text-sm text-text-secondary mt-6">
            ...
            <Link href="/login" className="text-signal-primary hover:text-signal-primary/80 font-medium">
              Sign in
            </Link>
          </p>
        </div>
