    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-slate-50 flex items-center justify-center px-4">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <Link
            href="/signup"
            className="group surface-card p-8 text-center hover:shadow-xl transition-all duration-200 hover:-translate-y-1 bg-gradient-to-br from-blue-50 to-indigo-50"
          >
            <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center group-hover:shadow-lg transition-shadow">
